...
from spytfire.spectrometer_sensor import SpecWorker
...
from spytfire.console_logger import ConsoleLogger
...
class FileLogger(QObject):
    ...
    def handle_spec(self, name, data_dict):
        ...
        lat, lon, alt = 'Not Implemented', 'Not Implemented', 'Not Implemented'
        correct_dark_counts  = 'Not Implemented'
        correct_nonlinearity = 'Not Implemented'
